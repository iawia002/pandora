...
type Interface interface {
	...
	FooV1alpha2() foov1alpha2.FooV1alpha2Interface
}
...
type Clientset struct {
	*discovery.DiscoveryClient
	...
	fooV1alpha2 *foov1alpha2.FooV1alpha2Client
}
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	cs.fooV1alpha2, err = foov1alpha2.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
...
func New(c rest.Interface) *Clientset {
	...
	cs.fooV1alpha2 = foov1alpha2.New(c)
