...
import (
	...
	clientset "github.com/iawia002/pandora/kubernetes/apis/example/generated/clientset"
	internalinterfaces "github.com/iawia002/pandora/kubernetes/apis/example/generated/informers/internalinterfaces"
	v1alpha1 "github.com/iawia002/pandora/kubernetes/apis/example/generated/listers/foo/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FooV1alpha1().Foos().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FooV1alpha1().Foos().Watch(context.TODO(), options)
			},
		},
		&foov1alpha1.Foo{},
		resyncPeriod,
