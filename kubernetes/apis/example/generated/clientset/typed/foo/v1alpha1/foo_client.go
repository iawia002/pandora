...
import (
	...
	"github.com/iawia002/pandora/kubernetes/apis/example/generated/clientset/scheme"
...
// FooV1alpha1Client is used to interact with features provided by the foo.example.io group.
type FooV1alpha1Client struct {
	restClient rest.Interface
}

func (c *FooV1alpha1Client) Foos() FooInterface {
	return newFoos(c)
}
